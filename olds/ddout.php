    ...
    if (isset($_POST['btn_simpan'])){
        ...
        if(!empty($ddo)){
         error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
           $sql = "INSERT INTO dolar (id, kode, keterangan, tgl, ddo, jenis, jeniss, pengeluaran) VALUES(".$id.",'".$kode."','".$keterangan."','".$tgl."','".$ddo."','".keluar."','".DD."','".$pengeluaran."')";
  ...
  <div id="tambahuser" class="modal fade" role="dialog" style="display:none;">
    <div class="modal-dialog"> 
      <div class="modal-content">
        ...
        <form action="apa.php" method="POST" enctype="multipart/form-data">
            ...
            <fieldset>
                <legend><h2>Tambah Data</h2></legend>
                  ...
                  <label for="pengeluaran">Jumlah Pengeluaran DD </label><input type="number" class="form-control" name="pengeluaran"/>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12"><h4>PENGELUARAN</h4>
                    <h1 class="page-header">Tables DD ( DANA DESA )</h1>
                </div>
...
include '../koneksi.php';}
                                    ...
                                    $no = 1;
                                    $sql = mysqli_query($koneksi, "SELECT * FROM dolar WHERE pengeluaran AND jeniss='DD' AND jenis = 'keluar' ");
                                ...
                                ?>
                                      <tr class="odd gradeX">
                                           ...
                                           <td align="right">
                                            ...
                                            <td>
                                                 <a class="btn btn-primary"  href="ddout.php?aksi=update&id=<?php echo $data['id']; ?>&kode=<?php echo $data['kode']; ?>&pembuat=<?php echo $data['pembuat']; ?>&keterangan=<?php echo $data['keterangan']; ?>&tgl=<?php echo $data['tgl']; ?>&pengeluaran=<?php echo $data['pengeluaran']; ?>&foto=<?php echo $data['foto'];?>">Ubah</a>|
                    <a class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="ddout.php?aksi=delete&id=<?php echo $data['id']; ?>">Hapus</a>
                                            </td>
                                ...
                                <tr>
                                  <?php error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));  ?>
                                    <td colspan="5" style="text-align: left; font-size: 17px; color: maroon;">Total DD OUT :</td>
  ...
  if($foto != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  ...
                  $perubahan = "kode='".$kode."',pembuat='".$pembuat."',keterangan='".$keterangan."',tgl='".$tgl."',pengeluaran='".$pengeluaran."',foto='".$nama_gambar_baru."'";
                   ...
                   $query  = "UPDATE dolar SET ".$perubahan." WHERE id=$id";
                    ...
                    if(!$result){
                      ...
                      echo "<script>alert('Data berhasil diubah.');window.location='ddout.php';</script>";
                    }
              } else {     
               //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                  echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='ddout.php';</script>";
              }
    } else {
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      ...
      if(!$result){
        ...
        //tampil alert dan akan redirect ke halaman index.php
        //silahkan ganti index.php sesuai halaman yang akan dituju
          echo "<script>alert('Data .');window.location='ddout.php';</script>";
      }
    }
    ...
    if(isset($_GET['id'])){
        ?>
            ...
            <fieldset>
              <a href="ddout.php"><button type="button" class="close" data-dismiss="modal" aria-label="Close" ><span aria-hidden="true">&times;</span></button></a>
                ...
                <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>"/>
                  ...
                  <label for="pengeluaran">Jumlah Pengeluaran DD </label><input type="number" class="form-control" name="pengeluaran" value="<?php echo $_GET['pengeluaran'] ?>"/>
          ...
          <i style="float: left;font-size: 11px;color: red">Abaikan jika tidak merubah gambar produk</i>
                  ...
                  <br>
                <label>
                    <input type="submit" name="btn_ubah" class="btn btn-primary" value="Simpan Perubahan"/>  atau <a  class="btn btn-danger" href="ddout.php">Batal</a>
                </label>
                <br>
                <p><?php echo isset($pesan) ? $pesan : "" ?></p>
               ...
               error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
                ...
                if($hapus) {
                        echo "
                                ...
                                document.location.href = 'ddout.php';
                                </script>";  
}else{ 
    echo "
                                <script>
...
if (isset($_GET['aksi'])){
    switch($_GET['aksi']){
        case "create":
            echo '<a href="ddout.php"> &laquo; Home</a>';
            tambah($koneksi);
            break;
        case "read":
            cari($koneksi);
