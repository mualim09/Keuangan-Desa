...
<div class="container">
    <form action="cekakpdfnew.php" method="post" target="_blank">
        <h4>CETAK PDF PENGELUARAN</h4>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="../cetak/cetakkeluarp.php" target="_blank" class="btn btn-primary">cetak</a>
