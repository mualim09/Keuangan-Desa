...
<div class="container">
    <form action="cekakexcelnew.php" method="post" target="_blank">
         <h4>CETAK EXCEL PENGELUARAN</h4>
 <legend>Berdasarkan Tanggal</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="../cetak/cetakkeluare.php" target="_blank" class="btn btn-primary">cetak</a>
