...
function tambah($koneksi){
    ...
    if (isset($_POST['btn_simpan'])){
        ...
        $id = time();
         ...
         error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
           $sql = "INSERT INTO dolar (id, kode, pembuat, keterangan, tgl, ddm, jenis, jeniss) VALUES(".$id.",'".$kode."','".$pembuat."','".$keterangan."','".$tgl."','".$ddm."', '".masuk."','".DD."')";
 ...
 if($sql) {
            ...
            if($simpan && isset($_GET['aksi'])){
             ...
             echo "
                                <script>
                                alert('Data DD Tidak Boleh Kosong');
        ...
        <form action="apa.php" method="POST" enctype="multipart/form-data">
            ...
            <fieldset>
                <legend><h2>Tambah data</h2></legend>
                  ...
                  <label for="pemasukan">Jumlah Pemasukan DD </label><input type="number" class="form-control" name="pemasukan"/>
...
include '../koneksi.php';}
                                    ...
                                    $no = 1;
                                    $sql = mysqli_query($koneksi, "SELECT * FROM dolar WHERE pemasukan AND jeniss='DD' AND jenis='masuk' ");
                                ...
                                ?>
                                      <tr class="odd gradeX">
                                            ...
                                            <td><a href="foto/<?php echo $data['foto']; ?>" class="perbesar"><img src="foto/<?php echo $data['foto']; ?>" width="50" /></a></td>



    
                                             <td>
                                                 <a class="btn btn-primary"  href="dd.php?aksi=update&id=<?php echo $data['id']; ?>&kode=<?php echo $data['kode']; ?>&pembuat=<?php echo $data['pembuat']; ?>&keterangan=<?php echo $data['keterangan']; ?>&tgl=<?php echo  $data['tgl']; ?>&pemasukan=<?php echo $data['pemasukan'];?>&foto=<?php echo $data['foto'];?>">Ubah</a> |
                    <a class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="dd.php?aksi=delete&id=<?php echo $data['id']; ?>">Hapus</a>
                                ...
                                <tr>
                                  <?php error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));  ?>
                                    <td colspan="5" style="text-align: left; font-size: 17px; color: maroon;">Total Kas DD :</td>
  ...
  if($foto != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  ...
                  $perubahan = "kode='".$kode."',pembuat='".$pembuat."',keterangan='".$keterangan."',tgl='".$tgl."',pemasukan='".$pemasukan."',foto='".$nama_gambar_baru."'";
                   ...
                   $query  = "UPDATE dolar SET ".$perubahan." WHERE id=$id";
                    ...
                    if(!$result){
                      ...
                      echo "<script>alert('Data berhasil diubah.');window.location='dd.php';</script>";
                    }
              } else {     
      ...
      if(!$result){
        ...
        //tampil alert dan akan redirect ke halaman index.php
        //silahkan ganti index.php sesuai halaman yang akan dituju
          echo "<script>alert('Data .');window.location='dd.php';</script>";
      }
    }
    ...
    if(isset($_GET['id'])){
        ?>
            ...
            <fieldset>
              <a href="dd.php"><button type="button" class="close" data-dismiss="modal" aria-label="Close" ><span aria-hidden="true">&times;</span></button></a>
                ...
                <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>"/>
                  ...
                  <label for="pemasukan">Jumlah Pemasukan DD </label><input type="number" class="form-control" name="pemasukan" value="<?php echo $_GET['pemasukan'] ?>"/>
                  <div>

          <label>Kwitansi</label><br>
          ...
          <i style="float: left;font-size: 11px;color: red">Abaikan jika tidak merubah gambar produk</i>
                ...
                <label>
                    ...
                    <br>
                    <br><a  class="btn btn-danger" href="dd.php">Batal</a>
                </label>
                <br>
                <p><?php echo isset($pesan) ? $pesan : "" ?></p>
...
if (isset($_GET['aksi'])){
    switch($_GET['aksi']){
        case "create":
            echo '<a href="dd.php"> &laquo; Home</a>';
            tambah($koneksi);
            break;
        case "read":
            cari($koneksi);
