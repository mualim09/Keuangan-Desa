...
function tambah($koneksi){
    ...
    if (isset($_POST['btn_simpan'])){
        ...
        $id = time();
         ...
         error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));
           $sql = "INSERT INTO dolar (id, kode, keterangan, tgl, dll, jenis, jeniss) VALUES(".$id.",'".$kode."','".$keterangan."','".$tgl."','".$dll."','".masuk."','".DLL."')";
 ...
 if($sql) {
                            ...
                            echo "
                                ...
                                document.location.href = 'dll.php';
                                </script>"; 
        ...
        <form action="apa4.php" method="POST" enctype="multipart/form-data">
            ...
            <fieldset>
                <legend><h2>Tambah data</h2></legend>
                  ...
                  <label for="pemasukan">Jumlah Pemasukan DLL </label><input type="number" class="form-control" name="pemasukan"/>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12"><h4>PEMASUKAN</h4>
                    <h1 class="page-header">Tables Dan Lain-Lain</h1>
                </div>
...
include '../koneksi.php';}
                                    ...
                                    $no = 1;
                                    $sql = mysqli_query($koneksi, "SELECT * FROM dolar WHERE pemasukan AND jeniss='DLL' AND jenis = 'masuk' ");
                                      ...
                                      <tr class="odd gradeX">
                                          ...
                                          <td align="right">
                                            ...
                                            <td><a href="foto/<?php echo $data['foto']; ?>" class="perbesar"> <img src="foto/<?php echo $data['foto']; ?>" width="50"/></td>
                                             ...
                                             <td>
                                                 <a class="btn btn-primary"  href="dll.php?aksi=update&id=<?php echo $data['id']; ?>&kode=<?php echo $data['kode']; ?>&pembuat=<?php echo $data['pembuat']; ?>&keterangan=<?php echo $data['keterangan']; ?>&tgl=<?php echo $data['tgl']; ?>&pemasukan=<?php echo $data['pemasukan']; ?>&foto=<?php echo $data['foto'];?>">Ubah</a> |
                    <a class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data?')" href="dll.php?aksi=delete&id=<?php echo $data['id']; ?>">Hapus</a>
                                ...
                                <tr>
                                  <?php error_reporting(E_ALL ^ (E_NOTICE | E_WARNING));  ?>
                                    <td colspan="5" style="text-align: left; font-size: 17px; color: maroon;">Total Kas DLL :</td>
  ...
  if($foto != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  ...
                  $perubahan = "kode='".$kode."',pembuat='".$pembuat."',keterangan='".$keterangan."',tgl='".$tgl."',pemasukan='".$pemasukan."',foto='".$nama_gambar_baru."'";
                   ...
                   $query  = "UPDATE dolar SET ".$perubahan." WHERE id=$id";
                    ...
                    if(!$result){
                      ...
                      echo "<script>alert('Data berhasil diubah.');window.location='dll.php';</script>";
                    }
              } else {     
               //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                  echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='dll.php';</script>";
              }
    } else {
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      ...
      if(!$result){
        ...
        //tampil alert dan akan redirect ke halaman index.php
        //silahkan ganti index.php sesuai halaman yang akan dituju
          echo "<script>alert('Data .');window.location='dll.php';</script>";
      }
    }
    ...
    if(isset($_GET['id'])){
        ?>
            ...
            <fieldset>
              <a href="dll.php"><button type="button" class="close" data-dismiss="modal" aria-label="Close" ><span aria-hidden="true">&times;</span></button></a>
                ...
                <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>"/>
                  ...
                  <label for="pemasukan">Jumlah Pemasukan DLL </label><input type="number" class="form-control" name="pemasukan" value="<?php echo $_GET['pemasukan'] ?>"/>
                  <div>
          ...
          <i style="float: left;font-size: 11px;color: red">Abaikan jika tidak merubah gambar produk</i>
                ...
                <label>
                    ...
                    <br>
                    <br><a  class="btn btn-danger" href="dll.php">Batal</a>
                </label>
                <br>
                <p><?php echo isset($pesan) ? $pesan : "" ?></p>
...
if (isset($_GET['aksi'])){
    switch($_GET['aksi']){
        case "create":
            echo '<a href="dll.php"> &laquo; Home</a>';
            tambah($koneksi);
            break;
        case "read":
            cari($koneksi);
