...
<div class="container">
    <form action="cetakpdfnew.php" method="post" target="_blank">
 <legend>Date Time Picker(cetak Pemasukan)</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="../cetak/cetakmasukp.php" target="_blank" class="btn btn-primary">cetak</a>
