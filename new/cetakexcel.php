...
<div class="container">
    <form action="cetakexcelnew.php" method="post" target="_blank">
 <legend>Date Time Picker(cetak PEMASUKAN)excel</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="../cetak/cetakmasuke.php" target="_blank" class="btn btn-primary">cetak</a>
