...
<div class="container">
    <form action="cetak01.php" method="post" target="_blank">
 <legend>Date Time Picker(cetak DD)excel</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="cetakaddex.php" target="_blank" class="btn btn-primary">cetak</a>
