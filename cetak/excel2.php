...
<div class="container">
    <form action="cetak02.php" method="post" target="_blank">
 <legend>Date Time Picker(cetak ADD)excel</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="cetakddex.php" target="_blank" class="btn btn-primary">cetak</a>
