...
<div class="container">
    <form action="cetak4.php" method="post" target="_blank">
 <legend>Date Time Picker(cetak Dll)</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="cetakdll.php" target="_blank" class="btn btn-primary">cetak</a>
