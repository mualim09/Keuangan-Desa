...
<div class="container">
    <form action="cetak3.php" method="post" target="_blank">
 <legend>Date Time Picker(cetak Bankeu)</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="cetakbankeu.php" target="_blank" class="btn btn-primary">cetak</a>
