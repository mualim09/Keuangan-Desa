...
<div class="container">
    <form action="cetak05.php" method="post" target="_blank">
 <legend>Date Time Picker(cetak Dll)excel</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="cetakdllo.php" target="_blank" class="btn btn-primary">cetak</a>
