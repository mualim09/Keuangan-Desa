...
<div class="container">
    <form action="cetak03.php" method="post" target="_blank">
 <legend>Date Time Picker(cetak Banprov)excel</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="cetakbanprovex.php" target="_blank" class="btn btn-primary">cetak</a>
