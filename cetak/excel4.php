...
<div class="container">
    <form action="cetak04.php" method="post" target="_blank">
 <legend>Date Time Picker(cetak Bankeu)excel</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="cetakbankeucel.php" target="_blank" class="btn btn-primary">cetak</a>
