...
<div class="container">
    <form action="cetakrekapexcel.php" method="post" target="_blank">
 <legend>Date Time Picker(cetak REKAP)excel</legend>
        <fieldset>
...
<hr>
<h4>Ingin Cetak Semuanya?</h4>Klik Disini  <a href="../../cetak/cetakexcel.php" target="_blank" class="btn btn-primary">cetak</a>
