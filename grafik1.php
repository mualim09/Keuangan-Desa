...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="grafik.php">GRAFIK PERBULAN</a></li>
    <li class="breadcrumb-item active" aria-current="page">GRAFIK MASUKAN and KELUARAN</li></a>
  </ol>
</nav>

   <h1 class="page-header">GRAFIK</h1>
   <h6 class="page-header">Berdasarkan Jenis</h6>
 ...
 <style type="text/css">
  ...
  <br>
  <br>
  <center><h1 class="page-header">GRAFIK PERBULAN</h1></center>
